...
class niat_wo_dis(nn.Module):
   
    def __init__(self, args):
        super(niat_wo_dis, self).__init__()
...
class niat_wo_rec(nn.Module):
   
    def __init__(self, args):
        super(niat_wo_rec, self).__init__()
...
class niat_wo_dis_rec(nn.Module):
   
    def __init__(self, args):
        super(niat_wo_dis_rec, self).__init__()
...
class niat_wo_da(nn.Module):
    def __init__(self, args):
        super(niat_wo_da, self).__init__()
